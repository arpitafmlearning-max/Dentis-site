          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-[#E2E8F0] space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="flex items-center gap-3 text-rose-600">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-light">
                  This review will be removed from the patient stories section.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC] p-3.5 rounded-2xl border border-[#E2E8F0] space-y-1 text-xs">
              <p className="font-bold text-slate-800">
                Patient: <span className="font-normal text-slate-600">{testimonialToDelete.patientName}</span>
              </p>
              <p className="font-bold text-slate-800">
                Comment: <span className="font-normal text-slate-600 italic">"{testimonialToDelete.comment}"</span>
              </p>
            </div>
